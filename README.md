...
This is a DSA capstone project analysis on a dataset culled from Amazon E-commerce platform 
...
#### Category Cleanup (Power Query)
The 'Product Category' field was cleaned and restructured to isolate parent categories. Used Power Query's Split Column, Replace Values, and Text.Trim to format and remove subcategories.
New Fields Created:
Sort Order column
...
<img width="1999" height="1545" alt="image" src="https://github.com/user-attachments/assets/c58720d1-b312-4a29-a6a9-f3b63b41e448" />
## Conclusion
